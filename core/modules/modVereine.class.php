...
class modVereine extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->menu[$r++] = array(
			'fk_menu' => 'fk_mainmenu=members,fk_leftmenu=vereine',
			'type' => 'left',
			'titre' => 'VereineMenuConsentForm',
			'mainmenu' => 'members',
			'leftmenu' => 'vereine_consentform',
			'url' => '/vereine/consents.php',
			'langs' => 'vereine@vereine',
			'position' => 1100 + $r,
			'enabled' => 'isModEnabled("vereine")',
			'perms' => '$user->hasRight("vereine", "association", "read")',
		...
		// Volunteer allowances with their limits and the list for the reports (#7).
		$this->menu[$r++] = array(
			'fk_menu' => 'fk_mainmenu=members,fk_leftmenu=vereine',
			'type' => 'left',
			'titre' => 'VereineMenuVolunteers',
			'mainmenu' => 'members',
			'leftmenu' => 'vereine_volunteers',
			'url' => '/vereine/volunteer.php',
			'langs' => 'vereine@vereine',
			'position' => 1100 + $r,
			'enabled' => 'isModEnabled("vereine")',
			'perms' => '$user->hasRight("vereine", "association", "read")',
		...
		// The files of the association: finished documents with their codes, and the export (#123).
		$this->menu[$r++] = array(
			'fk_menu' => 'fk_mainmenu=members,fk_leftmenu=vereine',
			'type' => 'left',
			'titre' => 'VereineMenuArchive',
			'mainmenu' => 'members',
			'leftmenu' => 'vereine_archive',
			'url' => '/vereine/archive.php',
			'langs' => 'vereine@vereine',
			'position' => 1100 + $r,
			'enabled' => 'isModEnabled("vereine")',
			'perms' => '$user->hasRight("vereine", "association", "read")',
		...
		$this->menu[$r++] = array(
			'fk_menu' => 'fk_mainmenu=members,fk_leftmenu=vereine',
			'type' => 'left',
			'titre' => 'VereineMenuAccount',
			'mainmenu' => 'members',
			'leftmenu' => 'vereine_account',
			'url' => '/vereine/account.php',
			'langs' => 'vereine@vereine',
			'position' => 1100 + $r,
			'enabled' => 'isModEnabled("vereine")',
			'perms' => '$user->hasRight("vereine", "association", "read")',
