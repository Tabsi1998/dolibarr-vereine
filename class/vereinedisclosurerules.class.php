...
class VereineDisclosureRules
{
	...
	const SECTIONS = array('member', 'extra', 'subscriptions', 'invoices', 'consents', 'applications', 'functions', 'exits', 'identities',
		'invitations', 'attendance', 'votes', 'signatures', 'tasks', 'duties', 'shifts', 'volunteer', 'donations', 'log');
