...
$prefixes = array(
	...
	'VereinePortalConsentState_' => array('given', 'withdrawn', 'none'),
	'VereinePortalRequest_' => VereineProfileRules::STATES,
	'VereinePortalShift_' => array('requested', 'confirmed', 'done', 'cancelled'),
